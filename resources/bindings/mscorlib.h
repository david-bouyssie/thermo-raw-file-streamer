...
typedef MonoEmbedObject System_Collections_IEnumerable;
typedef MonoEmbedObject System_Collections_Generic_IDictionary_2;
typedef MonoEmbedObject System_Collections_Generic_ICollection_1;
typedef MonoEmbedObject System_Collections_Generic_IEnumerable_1;
